        ...
        <div class="search-page-template">
          ...
          <div class="page-body">
            ...
            <div class="container searchPage-results-wrap">
              ...
              <!-- Load More Button -->
              <div class="text-center mb-4 my-md-5 search-result-item_out" v-if="loadMore2">
                <a href="javascript:void(0)" @click="loadMore" class="btn-white align-self-start me-lg-5"
...
*/
  ...
  .search-result-item_out>h4+a:hover,
